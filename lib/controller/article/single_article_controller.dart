...
class SingleArticleController extends GetxController {
  ...
  Future<void> getArticleInfo(var id) async {
    ...
    //TODO userId is in hard cord Mode
        ...
        log('${ApiYrlConstant.baseUrl}article/get.php?command=info&id=$id&user_id=$userId');
       var response = await DioService().getMethod('${ApiYrlConstant.baseUrl}article/get.php?command=info&id=$id&user_id=$userId');
